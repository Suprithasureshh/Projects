...
builder.Services.AddCors(options => {
    options.AddPolicy("AllowAnyOrigin", builder => { builder.AllowAnyOrigin(); builder.AllowAnyMethod(); builder.AllowAnyHeader(); });
});
...
//builder.Services.AddTransient<RoleActionFilterAttribute, EmployeeRepo>();
